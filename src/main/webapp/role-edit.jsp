        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="white-box">
                        <form action="<c:url value="/role/edit?id=${roleModel.getId()}"/>" method="post" class="form-horizontal form-material">
                            <div class="form-group">
                                <label class="col-md-12">ID</label>
                                <div class="col-md-12">
                                    <input type="text" placeholder="Id"
                                           class="form-control form-control-line" name="roleId" readonly value="${roleModel.getId()}" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Tên quyền"
                                           class="form-control form-control-line" name="name" value="${roleModel.getName()}" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Mô tả</label>
                                <div class="col-md-12">
                                    <input type="text" placeholder="Mô tả" class="form-control form-control-line" name="description" value="${roleModel.getDescription()}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
