        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="white-box">
                        <form action="<c:url value="/jobs/edit?id=${jobModel.getId()}"/>" method="post" class="form-horizontal form-material">
                            <div class="form-group">
                                <label class="col-md-12">ID</label>
                                <div class="col-md-12">
                                    <input type="text" placeholder="ID"
                                           class="form-control form-control-line" name="jobId" readonly value="${jobModel.getId()}"> </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Tên dự án</label>
                                <div class="col-md-12">
                                    <input type="text" placeholder="Tên công việc"
                                           class="form-control form-control-line" name="name" value="${jobModel.getName()}"> </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Ngày bắt đầu</label>
                                <div class="col-md-12">
                                    <input type="text" placeholder="yyyy-MM-dd"
                                           class="form-control form-control-line" name="start-date" value="${jobModel.getStartDate()}"> </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Ngày kết thúc</label>
                                <div class="col-md-12">
                                    <input type="text" placeholder="yyyy-MM-dd"
                                           class="form-control form-control-line" name="end-date" value="${jobModel.getEndDate()}"> </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button type="submit" class="btn btn-success">Update</button>
                                    <a href="<c:url value="/jobs"/>" class="btn btn-primary">Quay lại</a>
                                </div>
                            </div>
                        </form>
                    </div>
