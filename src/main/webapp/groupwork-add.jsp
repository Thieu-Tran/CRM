                ...
                <li>
                    <div class="dropdown">
                        <a class="profile-pic dropdown-toggle" data-toggle="dropdown" href="#">
                            <img src="<c:url value="/plugins/images/users/varun.jpg"/>" width="36" class="img-circle" />
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="white-box">
                        <form action="<c:url value="/jobs/add"/>" method="post" class="form-horizontal form-material">
