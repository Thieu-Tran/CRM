        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="white-box">
                        <form action="<c:url value="/user/edit?id=${userModel.getId()}"/>" method="post" class="form-horizontal form-material">
                            <div class="form-group">
                                <label class="col-md-12">ID</label>
                                <div class="col-md-12">
                                    <input name="userid" type="text" placeholder="id"
                                           class="form-control form-control-line" readonly value="${userModel.getId()}"> </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Full Name</label>
                                <div class="col-md-12">
                                    <input name="fullname" type="text" placeholder="Johnathan Doe"
                                           class="form-control form-control-line" value="${userModel.getFullname()}"> </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="email" placeholder="johnathan@admin.com"
                                           ...
                                           id="example-email" value="${userModel.getEmail()}"> </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Password</label>
                                <div class="col-md-12">
                                    <input name="password" type="password" value="${userModel.getPassword()}" class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select name="role" class="form-control form-control-line">
                                        <c:forEach var="item" items="${listRoles}">
                                            <option value="${item.id}" ${item.getId()==userModel.getRoleId()?"selected":""}>${item.description} </option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
